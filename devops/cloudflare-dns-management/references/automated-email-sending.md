...
### Vault-Based Credential Loading (Python Scripts)

For msmtp config, write credentials directly (file is 0600-protected). For Python scripts, read from the Hermes vault at runtime instead of hardcoding:
