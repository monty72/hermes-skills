...
For platform auth errors (e.g. "Auth failed" on Home Assistant, "No bot token configured"), see **`references/credential-management.md`** — covers credential layers, recovery via vault/pool, and platform-specific troubleshooting.
