...
| **content-site-builder** | Build informational/educational content sites — resource guides, knowledge hubs, reference directories with SVG illustrations and card grids | "build me a site about [topic]", "create a resource hub for [subject]", an informational reference guide with multiple sections |
...
- **Informational/educational content site** → content-site-builder
